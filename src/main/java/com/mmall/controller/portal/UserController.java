...
//    @ResponseBody
//    public ServerResponse<String> register(User user){//注册信息
...
//    @ResponseBody
//    public ServerResponse<User> getUserInfo(HttpSession session){//获取用户登录信息
//        User user = (User)session.getAttribute(Const.CURRENT_USER);
//        if(user != null){
//            return ServerResponse.createBySuccess(user);
//        }
//        return ServerResponse.createByErrorMessage("用户未登录，无法获取当前的用户的信息");
//    }
//
//    //忘记密码
...
//    @ResponseBody
//    public ServerResponse<String> forgetCheckAnswer(String username,String question,String answer){//验证问题是否正确
